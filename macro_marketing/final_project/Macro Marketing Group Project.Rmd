...
summary(lm(BumbleBee_demand ~ Covid*BumbleBee_inf_adj_price + Covid*Starkist_inf_adj_price + Covid*Others_inf_adj_price, unpiv_combine))
```
...
summary(lm(Starkist_demand ~ Covid*BumbleBee_inf_adj_price + Covid*Starkist_inf_adj_price + Covid*Others_inf_adj_price, unpiv_combine))
```
...
summary(lm(Others_demand ~ Covid*BumbleBee_inf_adj_price + Covid*Starkist_inf_adj_price + Covid*Others_inf_adj_price, unpiv_combine))
```
